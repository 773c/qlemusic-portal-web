<template>
  ...
  <div>
    ...
    <div v-show="!isMatchVerify" class="tabs-tel-content tabs-content">
      ...
      <el-button class="verify-button" type="primary" @click="regSendVerifyBtonHandler"
                 :style="isShowStyle" :disabled="isDisabled">
        {{CountDown}}
      </el-button>
      <br><br>
      ...
      <div class="tabs-reg-return-log" align="center" @click="returnLogClickHandler">
        返回登录
      </div>
    </div>
    <!--设置密码-->
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      returnLogClickHandler() {
        this.$emit("returnLogClickHandler")
      },
      regReset() {
